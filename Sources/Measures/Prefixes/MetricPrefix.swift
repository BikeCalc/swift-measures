...
public enum MetricPrefix: String {
    ...
    /// A prefix that multiplies the base unit by 1e+24.
    case yotta

    /// A prefix that multiplies the base unit by 1e+21.
    case zetta
    ...
    /// A prefix that multiplies the base unit by 1e+3.
    case kilo

    /// A prefix that multiplies the base unit by 1e+2.
    case hecto

    /// A prefix that multiplies the base unit by 1e+1.
    case deca
